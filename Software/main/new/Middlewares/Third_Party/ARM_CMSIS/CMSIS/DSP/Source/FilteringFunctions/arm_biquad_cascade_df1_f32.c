        ...
        uint32_t blockSize)
{
  ...
  do
  {
    ...
    a2 = *pCoeffs++;
		...
		volatile float32_t cpy_b0 = b0;
		volatile float32_t cpy_b1 = b1;
		volatile float32_t cpy_b2 = b2;
		volatile float32_t cpy_a1 = a1;
		volatile float32_t cpy_a2 = a2;
		
		volatile float32_t cpy_X;
		volatile float32_t cpy_X1;
		volatile float32_t cpy_X2;
		volatile float32_t cpy_Y1;
		volatile float32_t cpy_Y2;
